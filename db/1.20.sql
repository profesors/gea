...
--
-- Host: localhost:3306
-- Generation Time: Apr 26, 2020 at 11:09 PM
...
INSERT INTO `tokens` (`idBoard`, `name`, `file`, `pc`, `x`, `y`, `z`, `w`, `h`, `step`, `img`, `border`, `opacity`, `actionId`, `dice_result`, `dice_actionId`, `dice_action_targets`, `defaultGuideline`) VALUES
(1, 'bar', 'bar', 1, 14, 23, 1, 1, 1, 1, '005.png', '5px+solid+lime', 1, 13, NULL, 0, NULL, 1),
(1, 'exp', 'exp', 1, 14, 24, 1, 1, 1, 1, '006.png', '5px+solid+lime', 1, 26, NULL, 0, NULL, 2),
(1, 'elf', 'elf', 1, 14, 25, 1, 1, 1, 1, '007.png', '5px+solid+lime', 1, 40, NULL, 0, NULL, 3),
(1, 'g1', 'goblin', 0, 16, 9, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 0, 47, NULL, 0, NULL, 2),
(1, 'g2', 'goblin', 0, 8, 14, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 0, 54, NULL, 0, NULL, 1),
(1, 'g3', 'goblin', 0, 17, 8, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 0, 61, NULL, 0, NULL, 1),
(1, 'g4', 'goblin', 0, 19, 18, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 0, 68, NULL, 0, NULL, 2),
(1, 'e1', 'skeleton', 0, 5, 4, 1, 1, 1, 1, 'skeleton.jpg', '5px+solid+red', 0, 74, NULL, 0, NULL, 1),
(1, 'o1', 'ogre', 0, 11, 17, 1, 2, 2, 1, 'ogre.jpg', '5px+solid+red', 0, 81, NULL, 0, NULL, 1);
