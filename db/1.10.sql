...
--
-- Host: localhost:3306
-- Generation Time: Apr 21, 2020 at 08:25 PM
...
(1, 1, 1, '2020-04-21 18:24:16', 'bar se mueve a 13,16'),
(1, 1, 2, '2020-04-21 18:24:19', '<span class=\"name_text\">exp</span> ataca a <span class=\"name_text\">g2</span> con arco largo<span class=\"attack_text\">Ataque&nbsp;<span class=\"red\">9</span>=5(1d20) +2(enemigo predilecto) +1(distancia) +1(des)</span> <span class=\"red\">fallo</span></span> munición arco largo 19');
...
(1, 'Caravana', 70, 70, 20, 20, 0, 0, '004bg.jpg', 0, 58);
...
(1, 'exp', 2, 'arco largo', 'flmde_rangedAttack_enemy r8,15,23 d1d8', 19, 20),
...
INSERT INTO `tokens` (`idBoard`, `name`, `file`, `x`, `y`, `z`, `w`, `h`, `step`, `img`, `border`, `actionId`, `dice_result`, `dice_actionId`, `dice_action_targets`, `defaultGuideline`) VALUES
(1, 'bar', 'bar', 13, 16, 1, 1, 1, 1, '005.png', '5px+solid+lime', 56, NULL, 0, NULL, 1),
(1, 'exp', 'exp', 14, 14, 1, 1, 1, 1, '006.png', '5px+solid+lime', 58, '9 fallo', 58, 'g2', 2),
(1, 'g1', 'goblin', 9, 14, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 30, NULL, 0, NULL, 0),
(1, 'g2', 'goblin', 10, 15, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 36, NULL, 0, NULL, 0),
(1, 'g3', 'goblin', 10, 16, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 42, NULL, 0, NULL, 0),
(1, 'g4', 'goblin', 8, 17, 1, 1, 1, 1, 'goblin.jpg', '5px+solid+red', 48, NULL, 0, NULL, 0),
(1, 'e1', 'skeleton', 9, 17, 1, 1, 1, 1, 'skeleton.jpg', '5px+solid+red', 53, NULL, 0, NULL, 0);
