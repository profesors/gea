...
(1, 'Elven tower', 70, 70, 25, 25, 0, 0, '010bg.jpg', 0, 88);
...
(1, 'g5', 1, 'lanza', 'sword.png', 'flmde_attack r1 d1d6', -1, -1),
(1, 'g5', 2, 'arco corto', 'bow.png', 'flmde_rangedAttack r5,10,15 d1d6', 10, 10);
...
(1, 'g5', 'goblin', 0, 13, 21, 1, 1, 1, NULL, 1, 'goblin.jpg', '5px+solid+red', 0, 88, NULL, 0, NULL, 1);
